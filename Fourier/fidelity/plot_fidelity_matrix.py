    ...
    for parameter_set in parameter_sets:
        ...
        if 'job_name' in parameter_set:
            ...
            circuits = get_circuits(n, archs[backend_name], backend_name,
                                    initial_layout=parameter_set['logical_to_physical'])[0]
            jobs = test_locally_with_noise(circuits, backend_name)

        array = make_array(jobs, n, parameter_set.get('measure_logical_to_physical', None))

        plot(array, n, "qft_fid_{}_n={}_{}".format(backend_name, n, parameter_set.get('job_name', "sim")))
